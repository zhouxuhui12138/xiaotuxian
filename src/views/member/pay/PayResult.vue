  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-result">
        ...
        <div class="btn">
          <XtxButton type="primary" style="margin-right: 20px" @click="$router.push('/member/order')">查看订单</XtxButton>
...
import { findOrder } from "@/api/pay.js"
import { ref } from "vue"
